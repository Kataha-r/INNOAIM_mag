...
-- Dzięki temu klient dostaje tylko wybrane kolumny: dane produktu i dostępny stan.
-- Nadal ukrywamy lokalizację, minimum, statystyki, historię wysyłek i pola administracyjne.
drop function if exists public.get_client_products();
...
-- Wariant bez logowania e-mail: klient wpisuje kod dostępu w klient.html.
-- Funkcja zwraca tylko bezpieczne dane produktów przypisanych do tego kodu.
